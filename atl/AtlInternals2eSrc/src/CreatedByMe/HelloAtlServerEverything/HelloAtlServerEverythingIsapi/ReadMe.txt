========================================================================
       ATL SERVER : HelloAtlServerEverythingIsapi Project Overview
========================================================================

AppWizard has created this HelloAtlServerEverythingIsapi application for you.  This application
...
make up your HelloAtlServerEverythingIsapi application.

HelloAtlServerEverythingIsapi.vcproj
    This is the main project file for VC++ projects generated using an Application Wizard. 
    It contains information about the version of Visual C++ that generated the file, and 
    information about the platforms, configurations, and project features selected with the
    Application Wizard.
 
HelloAtlServerEverythingIsapi.cpp
...
HelloAtlServerEverythingIsapi.def
    ...
    CHelloAtlServerEverythingExtension class.
    The DLL also exports functions needed for perfmormance monitoring 
    support, however these do not appear in the HelloAtlServerEverythingIsapi.def file.
 
HelloAtlServerEverythingIsapi.rc
...
HelloAtlServerEverythingextension.h
    This file contains your CIsapiExtension derived ISAPI Extension class:
    CHelloAtlServerEverythingExtension that is customized based on the options you chose 
    in the AppWizard.
