// HelloAtlServerEverything.h : Defines the ATL Server request handler class
//
#pragma once

class CHelloAtlServerEverythingHandler
	: public CRequestHandlerT<CHelloAtlServerEverythingHandler>
{
private:
...
public:
	...
	BEGIN_REPLACEMENT_METHOD_MAP(CHelloAtlServerEverythingHandler)
