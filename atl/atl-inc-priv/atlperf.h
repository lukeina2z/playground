...
public:
    ...
    HRESULT CreateInstanceByNameWithBounds(
        DWORD dwCategoryId,
        LPCWSTR szInstanceName,
        CPerfObject** ppInstance,
        DWORD dwNumTotalInstances) noexcept;
...
protected:
...
#ifdef _ATL_PERF_REGISTER
	static BOOL CALLBACK EnumResLangProc(HINSTANCE hModule, LPCTSTR szType, LPCTSTR szName, LANGID wIDLanguage, LPARAM lParam) noexcept;
#endif
	...
	DWORD& _GetBlockId(CAtlFileMappingBase* pBlock) noexcept;
	...
	HRESULT CPerfMon::_CreateInstance(
		...
		CPerfObject** ppInstance,
		bool bByName,
		DWORD dwNUmTotalInstances = 0) noexcept;
