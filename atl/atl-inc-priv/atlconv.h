...
private:
	CW2WEX(_In_ const CW2WEX&) noexcept;
	CW2WEX& operator=(_In_ const CW2WEX&) noexcept;
};
typedef CW2WEX<> CW2W;
...
private:
	CA2AEX(_In_ const CA2AEX&) noexcept;
	CA2AEX& operator=(_In_ const CA2AEX&) noexcept;
};
typedef CA2AEX<> CA2A;
...
private:
	CA2CAEX(_In_ const CA2CAEX&) noexcept;
	CA2CAEX& operator=(_In_ const CA2CAEX&) noexcept;
};
...
private:
	CW2CWEX(_In_ const CW2CWEX&) noexcept;
	CW2CWEX& operator=(_In_ const CW2CWEX&) noexcept;
};
...
private:
	CA2WEX(_In_ const CA2WEX&) noexcept;
	CA2WEX& operator=(_In_ const CA2WEX&) noexcept;
};
typedef CA2WEX<> CA2W;
...
private:
	CW2AEX(_In_ const CW2AEX&) noexcept;
	CW2AEX& operator=(_In_ const CW2AEX&) noexcept;
};
typedef CW2AEX<> CW2A;
...
inline int ocslen(_In_opt_z_ LPCOLESTR x) noexcept
{
	if (x == NULL)
	{
		return 0;
