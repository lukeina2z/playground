...
inline BOOL AtlMimeCharsetFromCodePage(__out_ecount_z(cch) LPSTR szCharset, __in UINT uiCodePage, __in_opt IMultiLanguage* pMultiLanguage, __in size_t cch) noexcept
{
