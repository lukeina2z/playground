...
#define HTTP_PERMANENT_REDIRECT			HTTP_ERROR(308, SUBERR_NONE)
...
#define HTTP_IM_A_TEAPOT				HTTP_ERROR(418, SUBERR_NONE)
#define HTTP_MISDIRECTED_REQUEST		HTTP_ERROR(421, SUBERR_NONE)
#define HTTP_UNPROCESSED_ENTITY			HTTP_ERROR(422, SUBERR_NONE)
#define HTTP_LOCKED						HTTP_ERROR(423, SUBERR_NONE)
#define HTTP_FAILED_DEPENDENCY			HTTP_ERROR(424, SUBERR_NONE)
#define HTTP_UPGRADE_REQUIRED			HTTP_ERROR(426, SUBERR_NONE)
#define HTTP_PRECONDITION_REQUIRED		HTTP_ERROR(428, SUBERR_NONE)
#define HTTP_TOO_MANY_REQUESTS			HTTP_ERROR(429, SUBERR_NONE)
#define HTTP_REQUEST_HEADER_FIELDS_TOO_LARGE HTTP_ERROR(431, SUBERR_NONE)
...
ATL_NOINLINE inline HTTP_CODE AtlsHttpError(WORD wStatus, WORD wSubErr) noexcept
{
