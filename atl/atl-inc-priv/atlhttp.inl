...
inline CAtlHttpClientT<TSocketClass>::CAtlHttpClientT() noexcept
{
	InitializeObject();
}
...
template <class TSocketClass>
inline void CAtlHttpClientT<TSocketClass>::InitializeObject() noexcept
{
...
template <class TSocketClass>
inline void CAtlHttpClientT<TSocketClass>::ResetRequest() noexcept
{
...
template <class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::ConnectSocket() noexcept
{
	bool bRet=false;
...
inline bool CAtlHttpClientT<TSocketClass>::BuildRequest(/*out*/CString *pstrRequest,
										LPCTSTR szMethod,
										LPCTSTR szExtraHeaders)  noexcept
{
	if (!m_pNavData)
		return false;
	_ATLTRY
...
template <class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::ReadSocket() noexcept
{
	bool bRet = false;
...
// optionally.
template <class TSocketClass>
inline unsigned char* CAtlHttpClientT<TSocketClass>::FindHeaderEnd(unsigned char** ppBegin) noexcept
{
	if (!m_pCurrent)
		return NULL;
...
template <class TSocketClass>
inline typename CAtlHttpClientT<TSocketClass>::HTTP_RESPONSE_READ_STATUS CAtlHttpClientT<TSocketClass>::ReadHttpResponse() noexcept
{
...
template <class TSocketClass>
inline void CAtlHttpClientT<TSocketClass>::ResetConnection() noexcept
{
	ReconnectIfRequired();
	m_HeaderMap.RemoveAll();
	m_current.Empty();
...
template <class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::ProcessStatus(DWORD dwFlags) noexcept
{
	switch(m_nStatus)
	{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::GetHeaderValue(LPCTSTR szName, CString& strValue) const noexcept
{
	_ATLTRY
	{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::GetHeaderValue(__in_z LPCTSTR szName, __out_ecount_part_z_opt(*pdwLen, *pdwLen) LPTSTR szBuffer, __inout DWORD *pdwLen) const noexcept
{
	CString strValue;
...
inline bool CAtlHttpClientT<TSocketClass>::AddAuthObj(LPCTSTR szScheme,
				CAtlBaseAuthObject *pObject, IAuthInfo *pInfo/*=NULL*/) noexcept
{
	if (!pObject)
		return false;
...
// scheme
template<class TSocketClass>
inline const CAtlBaseAuthObject* CAtlHttpClientT<TSocketClass>::FindAuthObject(LPCTSTR szScheme) noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::RemoveAuthObject(LPCTSTR szScheme) noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::SetProxy(LPCTSTR szProxy, short nProxyPort) noexcept
{
	if (!szProxy)
	{
		if (!LookupRegProxy())
...
template<class TSocketClass>
inline void CAtlHttpClientT<TSocketClass>::RemoveProxy() noexcept
{
		m_strProxy.Empty();
...
template<class TSocketClass>
inline LPCTSTR CAtlHttpClientT<TSocketClass>::GetProxy() const noexcept
{
...
template<class TSocketClass>
inline short CAtlHttpClientT<TSocketClass>::GetProxyPort() const noexcept
{
	return m_nProxyPort;
}
...
template<class TSocketClass>
inline const BYTE* CAtlHttpClientT<TSocketClass>::GetResponse() noexcept
{
	return (const BYTE*)(LPCSTR)m_current;
}

template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::GetResponseLength() noexcept
{
...
// current response
template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::GetBodyLength() const noexcept
{
	return m_dwBodyLen;
}
...
template<class TSocketClass>
inline const BYTE* CAtlHttpClientT<TSocketClass>::GetBody() noexcept
{
...
template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::GetRawResponseHeaderLength() noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::GetRawResponseHeader(LPBYTE szBuffer, DWORD *pdwLen) noexcept
{
	if (!pdwLen)
		return false;
...
template<class TSocketClass>
inline LPCURL CAtlHttpClientT<TSocketClass>::GetCurrentUrl() const noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::SetDefaultMethod(LPCTSTR szMethod) noexcept
...
template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::GetFlags() const noexcept
{
	if (m_pNavData)
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::LookupRegProxy() noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::DisconnectIfRequired() noexcept
{
	CString strValue;
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::NegotiateAuth(bool bProxy) noexcept
{
...
template<class TSocketClass>
inline long CAtlHttpClientT<TSocketClass>::GetContentLength() noexcept
{
	CString strValue;
...
template<class TSocketClass>
inline LPCSTR CAtlHttpClientT<TSocketClass>::NextLine(BYTE* pCurr) noexcept
{
	if (!pCurr)
		return NULL;
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::IsMsgBodyChunked() noexcept
{
	CString strValue;
	return (
...
// white space.
template<class TSocketClass>
inline LPCSTR CAtlHttpClientT<TSocketClass>::FindEndOfHeader(LPCSTR pszStart) noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::DecodeHeader(LPCSTR pHeaderStart, LPCSTR pHeaderEnd) noexcept
{
	_ATLTRY
	{
...
template<class TSocketClass>
inline void CAtlHttpClientT<TSocketClass>::OnSetCookie(LPCTSTR) noexcept
{
	return;
}

template<class TSocketClass>
inline LPCSTR CAtlHttpClientT<TSocketClass>::ParseStatusLine(BYTE* pBuffer) noexcept
{
	if (!pBuffer)
		return NULL;
	if (m_pEnd <= pBuffer)
...
template<class TSocketClass>
inline int CAtlHttpClientT<TSocketClass>::CrackResponseHeader(LPCSTR pBuffer, /*out*/ LPCSTR *pEnd) noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::ReadBody(int nContentLen, int nCurrentBodyLen) noexcept
{
...
template<class TSocketClass>
inline typename CAtlHttpClientT<TSocketClass>::CHUNK_LEX_RESULT CAtlHttpClientT<TSocketClass>::get_chunked_size(char *&pBuffStart, char *&pBuffEnd, long* pnChunkSize) noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::move_leftover_bytes(__in_ecount(nLen) char *pBufferStart, __in int nLen, __deref_inout char *&pBuffStart, __deref_inout char *& pBuffEnd) noexcept
{
	bool bRet = true;
...
template<class TSocketClass>
inline typename CAtlHttpClientT<TSocketClass>::CHUNK_LEX_RESULT CAtlHttpClientT<TSocketClass>::consume_chunk_trailer(char *&pBufferStart, char *pBufferEnd) noexcept
{
	CHUNK_LEX_RESULT result = LEX_ERROR;
...
template<class TSocketClass>
inline typename CAtlHttpClientT<TSocketClass>::CHUNK_LEX_RESULT CAtlHttpClientT<TSocketClass>::consume_chunk_footer(char *&pBufferStart, char *&pBufferEnd) noexcept
{
	CHUNK_LEX_RESULT result = LEX_ERROR;
	if (pBufferStart < pBufferEnd &&
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::ReadChunkedBody() noexcept
{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::ReconnectIfRequired() noexcept
{
	CString strValue;
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::CompleteURL(CString& strURL) noexcept
{
	_ATLTRY
	{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::ProcessObjectMoved() noexcept
{
	_ATLTRY
	{
...
template<class TSocketClass>
inline bool CAtlHttpClientT<TSocketClass>::_SetDefaultUrl(LPCTSTR szURL, short nPort) noexcept
{
...
template<class TSocketClass>
inline int CAtlHttpClientT<TSocketClass>::GetStatus() noexcept
{
	return m_nStatus;
}

template<class TSocketClass>
inline LPCTSTR CAtlHttpClientT<TSocketClass>::GetMethod() noexcept
{
	return m_strMethod;
}

template<class TSocketClass>
inline BYTE* CAtlHttpClientT<TSocketClass>::GetPostData() noexcept
{
	if (m_pNavData)
...
template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::GetPostDataLen() noexcept
{
	if (m_pNavData)
...
template<class TSocketClass>
inline LPCTSTR CAtlHttpClientT<TSocketClass>::GetPostDataType() noexcept
{
	if (m_pNavData)
...
template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::GetLastError() noexcept
{
	return m_dwLastError;
}

template<class TSocketClass>
inline const SOCKET& CAtlHttpClientT<TSocketClass>::GetSocket() noexcept
{
	return const_cast<const SOCKET&>(m_socket);
}

template<class TSocketClass>
inline void CAtlHttpClientT<TSocketClass>::Close() noexcept
{
	TSocketClass::Close();
}

template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::SetSocketTimeout(DWORD dwNewTimeout) noexcept
{
	return TSocketClass::SetSocketTimeout(dwNewTimeout);
}

template<class TSocketClass>
inline DWORD CAtlHttpClientT<TSocketClass>::GetSocketTimeout() noexcept
{
	return TSocketClass::GetSocketTimeout();
}

template<class TSocketClass>
inline void CAtlHttpClientT<TSocketClass>::AuthProtocolFailed(LPCTSTR szProto) noexcept
{
	CAtlBaseAuthObject *pAuthObj = NULL;
	_ATLTRY
	{
...
//
/////////////////////////////////////////////////////////////////////////////////
inline CNTLMAuthObject::CNTLMAuthObject() noexcept :
	m_pSocket(NULL),
	m_nMaxTokenSize(0),
	m_pAuthInfo(NULL),
	m_bProxy(false)
...
inline CNTLMAuthObject::CNTLMAuthObject(IAuthInfo *pAuthInfo) noexcept :
	m_pSocket(NULL),
	m_nMaxTokenSize(0),
...
inline void CNTLMAuthObject::Init(CAtlHttpClient *pSocket, IAuthInfo *pAuthInfo) noexcept
{
	m_pSocket = pSocket;
	SetAuthInfo(pAuthInfo);
}

inline void CNTLMAuthObject::SetAuthInfo(IAuthInfo *pAuthInfo) noexcept
{
	m_pAuthInfo = pAuthInfo;
}

inline bool CNTLMAuthObject::Authenticate(LPCTSTR /*szAuthTypes*/, bool bProxy) noexcept
{
	m_bProxy = bProxy;
...
inline bool CNTLMAuthObject::AcquireCredHandle() noexcept
{
...
inline bool CNTLMAuthObject::DoNTLMAuthenticate() noexcept
{
	bool bRet = false;
	CString strVal;
...
inline bool CNTLMAuthObject::SendSecurityInfo(SecBuffer *pSecBuffer, LPSTR *pszBuffer) noexcept
{
...
//
/////////////////////////////////////////////////////////////////////////////////
inline bool CBasicAuthObject::DoBasicAuthenticate() noexcept
{
	bool bRet = false;
	ATLASSUME(m_pClient);
...
inline CBasicAuthObject::CBasicAuthObject() noexcept
{
	m_pClient = NULL;
	m_pAuthInfo = NULL;
	m_szRealm[0] = 0;
...
inline CBasicAuthObject::CBasicAuthObject(IAuthInfo *pAuthInfo) noexcept
{
	m_pAuthInfo = pAuthInfo;
	m_pClient = NULL;
}

inline void CBasicAuthObject::SetAuthInfo(IAuthInfo *pAuthInfo) noexcept
{
	m_pAuthInfo = pAuthInfo;
}
...
// authenticate a user.
inline bool CBasicAuthObject::Authenticate(LPCTSTR szAuthTypes, bool bProxy) noexcept
{
...
inline LPCTSTR CBasicAuthObject::GetRealm() noexcept
{
...
inline void CBasicAuthObject::Init(CAtlHttpClient *pSocket, IAuthInfo *pAuthInfo) noexcept
{
	ATLASSERT(pSocket);
	m_pClient = pSocket;
	if (pAuthInfo)
...
inline bool CBasicAuthObject::CrackRealm(LPCTSTR szHeader) noexcept
{
...
inline CAtlNavigateData::CAtlNavigateData() noexcept
{
...
inline DWORD CAtlNavigateData::SetFlags(DWORD dwNewFlags) noexcept
{
...
inline DWORD CAtlNavigateData::GetFlags() noexcept
{
	return dwFlags;
}

inline DWORD CAtlNavigateData::AddFlags(DWORD dwFlagsToAdd) noexcept
{
		// check for mutually exclusive flags
	if (
...
inline DWORD CAtlNavigateData::RemoveFlags(DWORD dwFlagsToRemove) noexcept
{
	DWORD dwOldFlags = dwFlags;
...
inline LPCTSTR CAtlNavigateData::SetExtraHeaders(LPCTSTR szNewHeaders) noexcept
{
...
inline LPCTSTR CAtlNavigateData::GetExtraHeaders() noexcept
{
	return szExtraHeaders;  
}
inline LPCTSTR CAtlNavigateData::SetMethod(LPCTSTR szNewMethod) noexcept
{
	LPCTSTR szold = szMethod;
	szMethod = szNewMethod;
	return szold;
}
inline LPCTSTR CAtlNavigateData::GetMethod() noexcept
{
	return szMethod;
}
inline short CAtlNavigateData::SetPort(short newPort) noexcept
{
	short oldport = nPort;
	nPort = newPort;
	return oldport;
}
inline short CAtlNavigateData::GetPort() noexcept
{
	return nPort;
}
inline void CAtlNavigateData::SetPostData(BYTE *pd, DWORD len, LPCTSTR type) noexcept
{
	pData = pd;
	dwDataLen = len;
	szDataType = type;
...
inline DWORD CAtlNavigateData::SetSocketTimeout(DWORD dwNewTimeout) noexcept
{
	DWORD dwold = dwTimeout;
	dwTimeout = dwNewTimeout;
	return dwold;
}
inline DWORD CAtlNavigateData::GetSocketTimeout() noexcept
{
	return dwTimeout;
}
inline DWORD CAtlNavigateData::SetSendBlockSize(DWORD dwNewBlockSize) noexcept
{
	DWORD dwold = dwSendBlockSize;
	dwSendBlockSize = dwNewBlockSize;
	return dwold;
}
inline DWORD CAtlNavigateData::GetSendBlockSize() noexcept
{
	return dwSendBlockSize;
}

inline DWORD CAtlNavigateData::SetReadBlockSize(DWORD dwNewBlockSize) noexcept
{
...
inline DWORD CAtlNavigateData::GetReadBlockSize() noexcept
{
	return dwReadBlockSize;
}

inline PFNATLCHUNKEDCB CAtlNavigateData::SetChunkCallback(PFNATLCHUNKEDCB pfn, DWORD_PTR dwParam) noexcept
{
...
inline PFNATLCHUNKEDCB CAtlNavigateData::GetChunkCallback() noexcept
{
	return pfnChunkCallback;
}

inline PFNATLSTATUSCALLBACK CAtlNavigateData::SetSendStatusCallback(PFNATLSTATUSCALLBACK pfn, DWORD_PTR dwData) noexcept
{
...
inline PFNATLSTATUSCALLBACK CAtlNavigateData::GetSendStatusCallback() noexcept
{
	return pfnSendStatusCallback;
}

inline PFNATLSTATUSCALLBACK CAtlNavigateData::SetReadStatusCallback(PFNATLSTATUSCALLBACK pfn, DWORD_PTR dwData) noexcept
{
...
inline PFNATLSTATUSCALLBACK CAtlNavigateData::GetReadStatusCallback() noexcept
{
