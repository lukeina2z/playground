...
#define AtlThrow(x) ATL::AtlThrowImpl(x, __FILE__, __LINE__)
#endif
#endif // AtlThrow
...
#ifndef ATLENSURE
#define ATLENSURE(expr) ATLENSURE_THROW(expr, E_UNEXPECTED)
#endif // ATLENSURE
...
#define ATLENSURE_RETURN(expr) ATLENSURE_RETURN_HR(expr, E_UNEXPECTED)
