...
inline bool ZEvtSyncSocket::Connect(LPCTSTR szAddr, unsigned short nPort) noexcept
{
	if (m_bConnected)
		return true;
...
inline DWORD ZEvtSyncSocket::GetSocketTimeout() noexcept
{
	return m_dwSocketTimeout;
}

inline DWORD ZEvtSyncSocket::SetSocketTimeout(DWORD dwNewTimeout) noexcept
{
...
inline bool ZEvtSyncSocket::SupportsScheme(ATL_URL_SCHEME scheme) noexcept
{
