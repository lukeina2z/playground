...
#ifndef __ATLProjectDLLFoo_i_h__
#define __ATLProjectDLLFoo_i_h__
...
EXTERN_C const IID IID_ICalculator;
    ...
    MIDL_INTERFACE("0535e1b4-a566-403d-905a-dad5863cdafb")
...
#ifndef __ATLProjectDLLFooLib_LIBRARY_DEFINED__
#define __ATLProjectDLLFooLib_LIBRARY_DEFINED__

/* library ATLProjectDLLFooLib */
/* [version][uuid] */ 


EXTERN_C const IID LIBID_ATLProjectDLLFooLib;

EXTERN_C const CLSID CLSID_Calculator;

#ifdef __cplusplus

class DECLSPEC_UUID("aba7fe24-4d6d-4290-b8e3-7449b120d560")
Calculator;
#endif
#endif /* __ATLProjectDLLFooLib_LIBRARY_DEFINED__ */
