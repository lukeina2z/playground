...
async def main():
    ...
    print("\n\n###  First Question   ###\n\n")    
    responseBar = await agent.run(
        "What day is today?"
    )
    print(str(responseBar))
   
    print("\n\n###  Second Question   ###\n\n")    
    responseFoo = await agent.run(
        "Search Find the span_id of the span took the longest time."
    )
    print(str(responseFoo))
