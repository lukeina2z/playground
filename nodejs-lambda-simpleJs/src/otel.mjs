...
export const myHandler = async (_event, _context) => {
    ...
    return tracer.startActiveSpan('my-main-span-for-lambda-handler',
        // { kind: SpanKind.SERVER, attributes: { "lambda.handler": "myHandler" ,
        // "aws.local.service": "my-lambda-fn-01-service-main-entrance",
        // "xkeyx": "my-lambda-fn-01-service-main-entrance" }},
        async (span) => {
            try {
